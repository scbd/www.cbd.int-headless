  ...
  <main class="cus-main cus-internal-page d-flex flex-column" role="main">
    <div class="main-wrapper">
      ...
      <div class="container-xxl d-flex">
        <!-- Vertical Submenu -->
        <!-- <navigation-submenu-vertical v-if="vertical.path && vertical.menu && vertical.menu[0]" :path="vertical.path" :menu="vertical.menu[0]"
        /> -->
        <article class="cus-article container-fluid d-flex flex-column">
          <!-- Breadcrumbs -->
          <!-- <navigation-breadcrumbs v-if="menus?.breadcrumbs" :path="menus.breadcrumbs" /> -->
          <section
