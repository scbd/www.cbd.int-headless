...
export function useMeetings (): {
  ...
  getMeeting: (code: MaybeRef<string>) => ReturnType<typeof useAsyncData<Meeting | undefined>>
} {
  function getMeetingList (options?: MaybeRef<QueryParams>): ReturnType<typeof useAsyncData<SearchResult<Meeting>>> {
  ...
  function getMeeting (code: MaybeRef<string>): ReturnType<typeof useAsyncData<Meeting | undefined>> {
  ...
  return { getMeetingList, getMeeting }
}
