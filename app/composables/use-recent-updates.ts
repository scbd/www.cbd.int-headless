...
export function useRecentUpdates (): {
  getRecentUpdateList: (options?: MaybeRef<QueryParams>) => ReturnType<typeof useAsyncData<SearchResult<RecentUpdate>>>
} {
  function getRecentUpdateList (options?: MaybeRef<QueryParams>): ReturnType<typeof useAsyncData<SearchResult<RecentUpdate>>> {
