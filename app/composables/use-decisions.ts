...
export function useDecision (): {
  getDecisionList: (options?: MaybeRef<QueryParams>) => ReturnType<typeof useAsyncData<SearchResult<Decision>>>
} {
  function getDecisionList (options?: MaybeRef<QueryParams>): ReturnType<typeof useAsyncData<SearchResult<Decision>>> {
