...
| [0003](0003-outcomes-remain-embedded-extended-with-kind-and-typed-links.md) | Outcomes stay embedded on the calendar activity, extended with `kind` and typed `links`; no separate collection or endpoints. Ratifies AADR 0002. | [AADR details](../aadr/details/0002.md) | accepted |
